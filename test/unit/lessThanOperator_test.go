...
func TestLessThanOperator(t *testing.T) {
	...
	t.Run("LessThanOperatorPass", func(t *testing.T) {
		dsl := `{"or":[{"custom_variable":{"eq":"lt(150)"}}]}`
	...
	t.Run("LessThanOperatorFail", func(t *testing.T) {
		dsl := `{"or":[{"custom_variable":{"eq":"lt(150)"}}]}`
		customVariables := map[string]interface{}{
			"eq":          200,
			"expectation": false,
	...
	t.Run("LessThanOperatorEqualValueFail", func(t *testing.T) {
		dsl := `{"or":[{"custom_variable":{"eq":"lt(150)"}}]}`
		customVariables := map[string]interface{}{
			"eq":          150,
			"expectation": false,
	...
	t.Run("LessThanOperatorStringValueFail", func(t *testing.T) {
		dsl := `{"or":[{"custom_variable":{"eq":"lt(150)"}}]}`
		customVariables := map[string]interface{}{
			"eq":          "abc",
			"expectation": false,
